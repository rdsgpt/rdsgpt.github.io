...
addEventListener("message", e => {
    ...
    if (e.data.type == "load") {
        ...
        let babelScriptTag = document.createElement("script");
        babelScriptTag.src = "https://unpkg.com/@babel/standalone/babel.min.js";
        document.body.appendChild(babelScriptTag);
    }
});
